...
# 1. 读取数据
charge = pd.read_csv('Submissions/richardzang/topic1/week2/B0005_charge_voltage.csv')
discharge = pd.read_csv('Submissions/richardzang/topic1/week2/B0005_discharge_voltage.csv')
